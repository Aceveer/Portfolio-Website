...
const Card = styled.div`
  ...
  background: white;
  background-image: url(${require("../../images/Uni of A Photo.jpg")});
...
const CardTitle = styled.div`
  font-weight: 600;
  font-size: 1rem;
  color: ${rgba("#00FFAA", 0.85)};
`;

const CardSubtitle = styled.div`
  color: ${rgba("#00FFAA", 0.57)};
  font-size: 0.875rem;
  margin-top: 0.5rem; /* Add margin between title and subtitle */
`;
  ...
  render() {
    ...
    return (
      <Wrapper>
        ...
        />
        <CardContent>
          <CardTitle>Tanveer Akram</CardTitle>
