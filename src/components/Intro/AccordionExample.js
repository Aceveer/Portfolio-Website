...
const Content1 = () => (
  <>
    <Text>This is the content for Dashboard</Text>
  </>
);

const Content2 = () => (
  <>
    <Text>This is the content for Support</Text>
  </>
);

const Content3 = () => (
  <>
    <Text>This is the content for Settings</Text>
  </>
);
...
const AccordionExample = ({}) => {
  ...
  const handleSetActive = (index) => {
    setActive(index);
    // Set selected content based on the clicked accordion item
    switch (index) {
      case 0:
